...
def render() -> None:
    ...
    with st.container(key="recent_records_controls", border=True):
        ...
        for index, record in enumerate(records):
            ...
            time_column, content_column, edit_column, delete_column = st.columns([1.05, 4.0, 0.35, 0.7 if delete_pending else 0.35])
