...
def render() -> None:
    ...
    with assistant_column:
        ...
        with st.container(border=True):
            ...
            for column, (label, topic) in zip(button_columns * 2, (("AI에 질문하기", ""), ("월령별 수유", "feeding"), ("주변 소아과", "hospital"), ("아기 안전 수칙", "safety"))):
