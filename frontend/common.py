...
def apply_style() -> None:
    st.markdown(
        ...
        div[data-testid="stFormSubmitButton"] button[data-testid="stBaseButton-primary"] { background:#6374DC !important; border-color:#6374DC !important; color:#FFFFFF !important; }
