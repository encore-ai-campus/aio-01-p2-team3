...
def render_feeding_reminder(reminder: dict) -> None:
    st.markdown(
        ...
        <div class="assistant-reminder"><div><b>🍼 마지막 수유 후 3시간이 지났어요</b><div class="assistant-reminder-sub">서아의 배고픔 신호를 확인해 주세요.</div></div><div><a class="assistant-reminder-btn primary" href="?demo=1&amp;page=%EC%9C%A1%EC%95%84%20%EA%B4%80%EB%A6%AC">수유했어요</a><a class="assistant-reminder-btn" href="?demo=1&amp;page=AI%20%EC%9C%A1%EC%95%84%20%EB%8F%84%EC%9A%B0%EB%AF%B8&amp;notice=snooze">10분 후</a><a class="assistant-reminder-btn" href="?demo=1&amp;page=AI%20%EC%9C%A1%EC%95%84%20%EB%8F%84%EC%9A%B0%EB%AF%B8&amp;notice=skip">건너뛰기</a></div></div>
        """,
        unsafe_allow_html=True,
    )
